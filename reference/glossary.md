...
**Stern-Brocot tree**
: Binary tree of all positive rationals, built by iterated mediants from $0/1$ and $1/0$. The framework's fundamental discrete structure. See [Our Address](https://nickjoven.github.io/submediant-site/our_address.html).
