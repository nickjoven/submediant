...
> Derived in: {doc}`03_einstein/13_einstein_from_kuramoto`
...
> Derived in: {doc}`01_alphabet/10_minimum_alphabet`
...
> Derived in: {doc}`02_field_equation/11_rational_field_equation`
...
> Derived in: {doc}`05_predictions/01_born_rule`
...
> Derived in: {doc}`06_evidence/03_a0_threshold`
...
> Derived in: {doc}`05_predictions/09_fidelity_bound`
...
> Derived in: {doc}`05_predictions/04_spectral_tilt_reframed`
...
> Derived in: {doc}`06_evidence/07_measurement_collapse`
...
> Derived in: {doc}`05_predictions/08_high_z_mond`
